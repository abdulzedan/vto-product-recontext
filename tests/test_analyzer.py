...
from bulk_image_processor.analyzer import (
    GeminiAnalyzer, ImageCategory, ClassificationResult, FeedbackResult
)
...
class TestGeminiAnalyzer:
    ...
    @pytest.mark.asyncio
    async def test_classify_image_apparel(self, mock_settings, mock_gemini_model, test_image_path):
    ...
    @pytest.mark.asyncio
    async def test_classify_image_product(self, mock_settings, mock_gemini_model, test_image_path):
    ...
    @pytest.mark.asyncio
    async def test_classify_image_with_additional_context(self, mock_settings, mock_gemini_model, test_image_path):
    ...
    @pytest.mark.asyncio
    async def test_classify_image_invalid_json_response(self, mock_settings, mock_gemini_model, test_image_path):
    ...
    @pytest.mark.asyncio
    async def test_classify_image_missing_fields(self, mock_settings, mock_gemini_model, test_image_path):
    ...
    @pytest.mark.asyncio
    async def test_classify_image_api_error(self, mock_settings, mock_gemini_model, test_image_path):
    ...
    @pytest.mark.asyncio
    async def test_analyze_virtual_try_on_quality_pass(self, mock_settings, mock_gemini_model, test_image_path):
    ...
    @pytest.mark.asyncio
    async def test_analyze_product_recontext_quality_fail(self, mock_settings, mock_gemini_model, test_image_path):
    ...
    @pytest.mark.asyncio
    async def test_generate_product_recontext_prompt(self, mock_settings, mock_gemini_model, test_image_path):
        ...
        result = await analyzer.generate_product_recontext_prompt(
            test_image_path,
            product_description="luxury ceramic vase"
        )
    ...
    async def test_classify_nonexistent_file(self, mock_settings, mock_gemini_model):
        ...
        with pytest.raises(Exception):  # PIL will raise an exception for nonexistent files
