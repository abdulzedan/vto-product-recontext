...
class TestUrlValidation:
    ...
    def test_invalid_image_urls(self):
        ...
        for url in invalid_urls:
            ...
            assert (
                result is False
            ), f"URL {url} should be invalid but was considered valid"
...
class TestImageEncoding:
    ...
    def test_prediction_to_pil_image(self):
        ...
        prediction = {"bytesBase64Encoded": encoded}
...
class TestGCSOperations:
    ...
    def test_upload_to_gcs(self, mock_storage_client, tmp_path):
        ...
        with patch("structlog.get_logger") as mock_logger:
            ...
            result = upload_to_gcs(
                test_file, "test-bucket", "path/to/test.txt", mock_client
            )
    ...
    def test_download_from_gcs(self, mock_storage_client, tmp_path):
        ...
        with patch("structlog.get_logger") as mock_logger:
            ...
            download_from_gcs(
                "gs://test-bucket/path/to/file.txt", local_path, mock_client
            )
