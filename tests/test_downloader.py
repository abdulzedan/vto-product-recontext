...
class TestImageDownloader:
    ...
    async def test_download_single_image_success(self, mock_get, mock_settings, sample_image_record, tmp_path):
        ...
        with patch('PIL.Image.open') as mock_image_open:
            ...
            async with ImageDownloader(mock_settings) as downloader:
                result = await downloader.download_single_image(sample_image_record, tmp_path)
    ...
    @pytest.mark.asyncio
    @patch('aiohttp.ClientSession.get')
    async def test_download_single_image_http_error(self, mock_get, mock_settings, sample_image_record, tmp_path):
