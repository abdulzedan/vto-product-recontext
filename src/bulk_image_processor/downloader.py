...
class ImageDownloader:
    ...
    async def download_images(
        ...
        async def download_with_semaphore(record: ImageRecord) -> Tuple[ImageRecord, Optional[Path]]:
        ...
        logger.info(
            ...
            **self.download_stats,
            success_rate=round(self.download_stats['successful'] / max(len(records), 1) * 100, 2),
